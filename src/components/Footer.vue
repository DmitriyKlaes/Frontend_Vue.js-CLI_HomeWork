<template>
    <footer class="footer">
        <div class="footer__left">
            ...
            <div class="footer__social">
                <a href="#" class="footer__link">
                    <svg viewBox="0 0 19 16" width="19" height="16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="#" class="footer__link">
                    <svg viewBox="0 0 17 16" width="17" height="16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="footer__contacts">
            ...
            <p class="footer__info">55 East Birchwood Ave. Brooklyn, New York 11201</p>
