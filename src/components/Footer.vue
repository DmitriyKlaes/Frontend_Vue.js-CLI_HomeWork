  ...
  <footer class="footer">
    <div class="footer__left">
      <div class="footer__name">
        <router-link to="/" href="#" class="footer__logo">
          <svg
            viewBox="0 0 34 34"
            width="34"
            height="34"
        ...
        <div class="header__head">Interno</div>
      </div>
    ...
    <div class="footer__nav">
      <h3 class="footer__nav-heading">Pages</h3>
      <router-link to="/" class="footer__link">Home</router-link>
      <router-link to="/project" class="footer__link">Project</router-link>
    ...
    <div class="footer__contacts">
      ...
      <p class="footer__info">contact@interno.com</p>
...
@import '@/assets/styles/text-style.scss';
...
.footer {
  ...
  &__head {
    @include fontStyle(40px, $textColor);
  }
  ...
  &__link {
    font-family: $smallTextFont;
    @include fontStyle(22px, $textColor);
  }
  ...
  &__info {
    font-family: $smallTextFont;
    @include fontStyle(22px, $secondTextColor);
    letter-spacing: 0.22px;
  }
}
</style>
